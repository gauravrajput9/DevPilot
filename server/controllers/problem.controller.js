...
export const createProblemTestCase = async (req, res) => {
  console.log("HIT CREATE TEST CASE");
  ...
  try {
    ...
    // Push only the test case into the existing document
    ...
    const createdTestCase =
      updatedProblem.testCases[updatedProblem.testCases.length - 1];

    return res.status(201).json({
      success: true,
      message: "Test case created successfully",
      testCase: createdTestCase,
      count: updatedProblem.testCases.length,
    });
  } catch (error) {
    console.log("createProblemTestCase Error:", error);
...
export const updateProblemTestCase = async (req, res) => {  }